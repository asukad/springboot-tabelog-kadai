...
public class AdminRestaurantController {
    ...
    public String edit(@PathVariable(name = "id") Integer id, Model model) {
        ...
        RestaurantEditForm restaurantEditForm = new RestaurantEditForm(restaurant.getId(), restaurant.getName(),restaurant.getCategory(),  null, restaurant.getDescription(), restaurant.getPriceRange(), restaurant.getAddress(), restaurant.getOpenAt(), restaurant.getCloseAt(), restaurant.getClosedOn(), restaurant.getCapacity());
